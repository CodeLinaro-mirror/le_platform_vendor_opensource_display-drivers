...
#define DSI_PLL_5NM_PLL_MAX	(2500000000)

u64 dsi_pll_5nm_dphy_vco_limit[] = {
	6000000000,
	780000000,
};

u64 dsi_pll_7nm_dphy_vco_limit[] = {
	5000000000,
	780000000,
};

#if 0 // Usually the PLL frequency doesn't affect the jitter much
struct dsi_pll_vco_div_table pll_5nm_dphy_div_table[] = {
	/* 16x VCO */
	{ 2, 8 },
	{ 4, 4 },
	{ 8, 2 },
